...
set CLASSPATH=%APP_HOME%\lib\Halyard-all.jar

@rem Execute Halyard
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HALYARD_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%HALYARD_EXIT_CONSOLE%" exit 1
exit /b 1
