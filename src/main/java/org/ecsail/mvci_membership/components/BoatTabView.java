...
public class BoatTabView implements Builder<Tab> {
    ...
    private TableColumn<BoatDTOFx, String> column1;
    ...
    private TableColumn<BoatDTOFx,String> col10() {
        TableColumn<BoatDTOFx, String> col10 = TableColumnFx.editableStringTableColumn(BoatDTOFx::displacementProperty,"Displacement");
        col10.setOnEditCommit(t -> editAndUpdateCell(t,"setDisplacement"));
        col10.setMaxWidth(1f * Integer.MAX_VALUE * 10);  // Trailer
        return col10;
    }

    private TableColumn<BoatDTOFx,String> col9() {
        TableColumn<BoatDTOFx, String> col9 = TableColumnFx.editableStringTableColumn(BoatDTOFx::draftProperty,"Draft");
        col9.setOnEditCommit(t -> editAndUpdateCell(t,"setDraft"));
        col9.setMaxWidth(1f * Integer.MAX_VALUE * 10);   // Weight
        return col9;
    }

    private TableColumn<BoatDTOFx,String> col8() {
        TableColumn<BoatDTOFx, String> col8 = TableColumnFx.editableStringTableColumn(BoatDTOFx::loaProperty,"LOA");
        col8.setOnEditCommit(t -> editAndUpdateCell(t,"setLoa"));
        col8.setMaxWidth(1f * Integer.MAX_VALUE * 10);   // Length
        return col8;
    }

    private TableColumn<BoatDTOFx,String> col7() {
        final TableColumn<BoatDTOFx, String> col7 = TableColumnFx.editableStringTableColumn(BoatDTOFx::lwlProperty,"LWL");
        col7.setOnEditCommit(t -> editAndUpdateCell(t,"setLwl"));
        col7.setMaxWidth(1f * Integer.MAX_VALUE * 5);   // PHRF
        return col7;
    }

    private TableColumn<BoatDTOFx, String> col5() {
        TableColumn<BoatDTOFx, String> col5 = TableColumnFx.editableStringTableColumn(BoatDTOFx::registrationNumProperty, "Registration");
        col5.setOnEditCommit(t -> editAndUpdateCell(t,"setRegistrationNum"));
        col5.setMaxWidth(1f * Integer.MAX_VALUE * 10);  // Registration
        return col5;
    }

    private TableColumn<BoatDTOFx, String> col4() {
        final TableColumn<BoatDTOFx, String> col4 = TableColumnFx.editableStringTableColumn(BoatDTOFx::modelProperty, "Model");
        col4.setOnEditCommit(t -> editAndUpdateCell(t,"setModel"));
        col4.setMaxWidth(1f * Integer.MAX_VALUE * 20);  // Model
        return col4;
    }

    private TableColumn<BoatDTOFx, String> col3() {
        TableColumn<BoatDTOFx, String> col3 = TableColumnFx.editableStringTableColumn(BoatDTOFx::manufactureYearProperty, "Year");
        col3.setOnEditCommit(t -> editAndUpdateCell(t,"setManufactureYear"));
        col3.setMaxWidth(1f * Integer.MAX_VALUE * 5);   // Year
        return col3;
    }

    private TableColumn<BoatDTOFx, String> col2() {
        TableColumn<BoatDTOFx, String> col2 = TableColumnFx.editableStringTableColumn(BoatDTOFx::manufacturerProperty, "Manufacturer");
        col2.setOnEditCommit(t -> editAndUpdateCell(t,"setManufacturer"));
        col2.setMaxWidth(1f * Integer.MAX_VALUE * 15);  // Manufacturer
        return col2;
    }

    private TableColumn<BoatDTOFx, String> col1() {
        TableColumn<BoatDTOFx, String> col1 = TableColumnFx.editableStringTableColumn(BoatDTOFx::boatNameProperty, "Boat Name");
        column1 = col1;
    ...
    private void editAndUpdateCell(TableColumn.CellEditEvent<BoatDTOFx, String> t, String type) {
        BoatDTOFx boatDTO = t.getTableView().getItems().get(t.getTablePosition().getRow());
        switch (type) {
